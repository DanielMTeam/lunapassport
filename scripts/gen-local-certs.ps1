...
Write-Host "       192.168.1.11 passport-staging.alexsyw.me memberservices-staging.alexsyw.me"
Write-Host "  2. Import passport-local.reg; trust _data\passport-mock.crt"
Write-Host "  3. go run .\cmd\lunapassport -http :8080 ``"
Write-Host "       -passport-host passport-staging.alexsyw.me ``"
Write-Host "       -memberservices-host memberservices-staging.alexsyw.me ``"
Write-Host "       -passport-cookie-domain .alexsyw.me"
